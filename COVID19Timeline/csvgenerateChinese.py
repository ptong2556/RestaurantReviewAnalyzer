...
#find for Chinese After COVID
NCAC_b_id_to_ratings = defaultdict(list)
file_path = "COVID19Timeline/ChineseAfterCOVID.json"
with open(file_path, "r") as file:
    json_data = json.load(file)
    for review in json_data:
        business_id = review.get("business_id")
...
with open("COVID19Timeline/covidRatingsChinese.csv", mode = "w", newline="") as csv_file:
